<?php
    ...
    if($count == 0){
        ...
        {
            $query4=mysqli_query($conn,"INSERT into tblattendance(rollNo,classId,semTermId,status,dateTimeTaken) value('$ros[rollNumber]','$_SESSION[classId]','$semTermId','0','$dateTaken')");
        }
    }
...
<body>
    ...
    <div class="home-content">
                ...
                <span class="text">Attendace Management System</span>
            </div>
                            ...
                            <?php
                                ...
                                if($num > 0)
                                {
                                    while ($rows = $rs->fetch_assoc()) {
                                        ...
                                        echo "<input name='admissoionNO[]' type='hidden' class='form-control' value=".$rows['admissionNumber']." >";
                                    }
                                }
                                else
                                {

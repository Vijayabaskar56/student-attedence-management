...
<body>
        <section class="home-section">
            ...
            <?php
                ...
                $query4 = mysqli_query($conn,"select * from tblclassteacher");
                $query5 = mysqli_query($conn,"select * from tblsem");
                $query6 = mysqli_query($conn,"select * from tblsemterm");

                $students = mysqli_num_rows($query1);
                $class = mysqli_num_rows($query2);
                $attendance = mysqli_num_rows($query3);
                $teacher = mysqli_num_rows($query4);
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <div class="details-opt"><?php echo $teacher; ?></div>
                    <div class="details-icon">

...
<head>
    ...
    <?php include '../Admin/include/title.php'; ?>
    <style>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT DISTINCT tblstudents.Id, tblclass.className, tblstudents.firstName, 
                                tblstudents.lastName, tblstudents.emailAddress, tblstudents.rollNumber, 
                                tblstudents.dateCreated FROM tblstudents INNER JOIN tblclass ON tblstudents.classId = tblclass.Id";
                                $rs = $conn->query($query);
                                $num = $rs->num_rows;   
                                $sn=0;
                                if($num > 0)

...
<section class="home-section">
    <div class="home-content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">/Create Class Teacher</li>
        </ol>
        </div>
            ...
            <div class="table-container">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT DISTINCT tblclassteacher.Id, tblclass.className, 
                                tblclassteacher.firstName, tblclassteacher.lastName, tblclassteacher.emailAddress, 
                                tblclassteacher.phoneNo, tblclassteacher.dateCreated FROM tblclassteacher INNER JOIN tblclass ON tblclassteacher.classId = tblclass.Id";
                                $rs = $conn->query($query);
                                $num = $rs->num_rows;
                                $sn=0;
                                $status="";

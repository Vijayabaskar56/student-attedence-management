    ...
    <body>
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <div class="icon-link">
                    <a href="https://localhost/hod/Admin/createClass.php">
                ...
                <li>
                    <div class="icon-link">
                    <a href="https://localhost/hod/Admin/createClassTeacher.php">
                ...
                <li>
                    <div class="icon-link">
                    <a href="https://localhost/hod/Admin/createstudent.php">
                ...
                <li>
                    <div class="icon-link">
                    <a href="https://localhost/hod/Admin/createTerm.php">

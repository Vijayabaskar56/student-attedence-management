          ...
          <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <input type="text" name="batchName" value="<?php echo isset($row['batchName']) ? $row['batchName'] : ''; ?>" id="exampleInputFirstName" class="formcontrol" placeholder="Class Name" >
            ...
            <div class="card-input">
                <div class="card">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT tblsemterm.Id,tblsemterm.batchName,tblsemterm.isActive,tblsemterm.dateCreated, tblsem.semName FROM tblsemterm INNER JOIN tblsem ON tblsem.Id = tblsemterm.semId";
                                $rs = $conn->query($query);
                                $num = $rs->num_rows;
                                $sn=0;
                                if($num > 0)
